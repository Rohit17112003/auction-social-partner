    ...
    <section className="space-y-6">
      ...
      <div className="bg-lightyellow text-light flex items-center justify-between gap-2 rounded-xl px-3 py-3">
        <div className="flex w-full items-center gap-3">
          ...
          <span className="text-xl font-semibold">Tax Exemption Document</span>
        </div>
      ...
      <div className="bg-light rounded-lg p-8 grid md:grid-cols-3 md:px-20 gap-8 md:gap-10">
        <SimpleImageUploader orgName="ABC Foundation" label="Tax Form 2025" />
        <SimpleImageUploader orgName="XYZ NGO" label="Exemption Letter" />
        <SimpleImageUploader orgName="Helping Hands" label="Donation Approval" />
        <SimpleImageUploader orgName="Green Earth Org" label="Tax Receipt" />
        <SimpleImageUploader orgName="EduCare" label="Document Proof" />
        <SimpleImageUploader orgName="Health First" label="Tax Filing" />
      </div>
    </section>
  );
};
